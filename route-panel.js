...
export function renderRoutePanel(data,day){
 ...
 const first=data.anchors[days[0].route[0]],mainLink=document.getElementById('open-domestic-map');
 mainLink.href=amapMarkerUrl(first);mainLink.textContent='高德地图 · '+first.name;
